...
class Home extends Component {
  ...
  componentDidMount() {
    ...
    socket.emit('am i game master?');
  }

  componentWillUnmount() {
    socket.emit('user left', {username: this.props.handleAuth.username});
  }
  ...
  drawLotteryBall() {
    ...
    socket.emit('draw lottery ball', data);
